...
class DiffuRec(nn.Module):
    ...
    def forward(self, item_rep_tuple, item_tag_tuple, mask_seq):        
        ...
        return x_0, item_rep_out, weights, t, x_t, dy_pre_x_t
...
class MM_TD_Rec(SequentialRecommender):
    """
    ...
    def __init__(self, config, dataset, index_to_id, index_to_keys, num_patches, text_emb=None, image_emb=None):
        super(MM_TD_Rec, self).__init__(config, dataset)
    ...
    def forward(self, item_seq, item_seq_len, next_item):
        ...
        x_0_pred_latent, seq_rep_diffusion_model, weights, t, x_t_noisy, dy_pre_x_t= \
        ...
        return id_seq_output, text_seq_output, image_seq_output, text_emb, image_emb
    ...
    def calculate_loss(self, interaction):
        ...
        id_seq_output, text_seq_output, image_seq_output, text_emb, image_emb = self.forward(item_seq, item_seq_len, pos_items)
